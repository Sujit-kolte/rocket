import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css                        */import{initializeApp as o}from"https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js";import{getFirestore as a,getDocs as n,collection as d}from"https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js";const l={apiKey:"AIzaSyAG5FBYdCAu5-O44w4XdKbDE-w6hdkq6Zs",authDomain:"stestest-5c37b.firebaseapp.com",projectId:"stestest-5c37b",storageBucket:"stestest-5c37b.firebasestorage.app",messagingSenderId:"411889626084",appId:"1:411889626084:web:f6ed382e7b52d13265f5f1",measurementId:"G-V6RZLD7G1X"},p=o(l),f=a(p);async function m(s){const t=document.querySelector(s);if(t)try{const r=await n(d(f,"projects"));t.innerHTML="",r.forEach(c=>{const e=c.data();if(e.enabled===!1)return;const i=`
      ...
      `;t.insertAdjacentHTML("beforeend",i)})}catch(r){console.error("Error fetching rockets:",r)}}m(".projects-section");
